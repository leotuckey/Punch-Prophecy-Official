...
function selectFighter(id, out) {
  ...
  if (checkFileExist("src/models/buildingMLModel/gifs/postCNNGIFs/" + name_decoded + ".gif")) {
    ...
    //document.getElementById("fighter" + i + "pic").src = "redgloves.jpg" //sets the image
    document.getElementById("fighter" + 1 + "pic").src = "redperson.jpg" //sets the image
    document.getElementById("fighter" + 2 + "pic").src = "blueperson.jpg" //sets the image
  }
  if (i == '1') {
